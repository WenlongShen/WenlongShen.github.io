...
HTMLActuator.prototype.tileHTML = ["小学", "初中", "中考", "高中", "高考", "本科", "考研", "硕士", "考博", "博士", "博后", "助教", "副教", "教授", "院士"];
...
HTMLActuator.prototype.scoreWeiboButton = function () {
  var weibo = document.createElement("a");
  var text = "I scored " + this.score + " points at 2048. Have fun here!";
  var url = "https://wenlongshen.github.io/2048";
  var weiboHref ='http://v.t.sina.com.cn/share/share.php?title='+text+'&url='+url+'&content=utf-8&sourceUrl='+url;
  weibo.classList.add("weibo-share-button");
  weibo.setAttribute("href", weiboHref);
  weibo.textContent = "分享至微博";
  return weibo;
};
